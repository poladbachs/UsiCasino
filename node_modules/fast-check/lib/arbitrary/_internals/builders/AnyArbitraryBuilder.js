...
function dictOf(ka, va, maxKeys, size, depthIdentifier, withNullPrototype) {
    return (0, tuple_1.tuple)((0, uniqueArray_1.uniqueArray)((0, tuple_1.tuple)(ka, va), {
        maxLength: maxKeys,
        size,
        selector: (t) => t[0],
        depthIdentifier,
    }), withNullPrototype ? (0, boolean_1.boolean)() : (0, constant_1.constant)(false)).map(KeyValuePairsToObject_1.keyValuePairsToObjectMapper, KeyValuePairsToObject_1.keyValuePairsToObjectUnmapper);
}
